        ...
        tabPanel("Help / Log",
          tabsetPanel(
            tabPanel("Help",
              ...
              # tags$ul(
              #   tags$li(strong("Start here: "), "Read ", code("app/app.R"), ", ", code("app/R/helpers.R"), ", ", code("app/R/build_uniprot_description_file.R"), " and any relevant file in ", code("app/legacy_scripts/"), ". Preserve existing Shiny patterns instead of redesigning the app."),
              ...
              #   tags$li(strong("Testing after edits: "), "At minimum run ", code("Rscript -e \"parse('app/app.R')\""), " and source any changed helper scripts. For mapping changes, test a small known ID example, such as human ", code("ENSG00000141510"), " mapping to Entrez ", code("7157"), " or UniProt ", code("P04637"), "."),
